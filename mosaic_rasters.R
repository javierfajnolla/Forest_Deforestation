...
writeRaster(rast_mosaic_fl, "data/raster/world/tc/forestloss_2000_2016", format = "GTiff")
...
writeRaster(rast_mosaic_fl2010, "data/raster/world/tc/forestloss_2000_2010", format = "GTiff")
